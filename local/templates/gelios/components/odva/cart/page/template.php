<div class="cart__wr">
    <div class="container">
        ...
        <?php
            if(empty($arResult['RESULT']['PRODUCTS']))
            {
                ?>
            ...
            else
            {
                ...
                <div class="cart__detail">
                    <div class="cart__detail-left">
                        ...
                        <?php
                            foreach ($arResult['RESULT']['PRODUCTS'] as $product)
                            {
                                ?>
                                <div class="cart__detail-item">
                                    <div class="cart__detail-close" data-product-id="<?=$product['ID']?>" onclick="odvaCart.removeItem(event,this); o2.popups.hideElem(this, 'cart__detail-item')">
                                    ...
                                    <div class="cart__detail-qn">
                                        <div>
                                            <div class="cart__detail-text"><?=$product['NAME']?></div>
                                            <div class="cart__detail-count" data-product-id="<?=$product['PRODUCT_ID']?>">
                                        ...
                                        <div>
                                            <div class="cart__detail-price"><span><?=$product['PRICE']*$product['QUANTITY']?></span> ₽</div>
                                            <div
                            ...
                            <div class="checkout-summary">
                                ...
                                <div class="checkout-summary__item">
                                    <div class="checkout-summary__line">
                                        <span class="checkout-summary__line--count">Товар (<?=$arResult['COUNT']['ITEMS']?>)</span>
...
BX.message({
    ...
    PATH_CHANGE_QUANTITY:'<?=$arResult['PATH_CHANGE_QUANTITY']?>',
    PATH_REMOVE_ITEM:'<?=$arResult['PATH_REMOVE_ITEM']?>'
});
</script>