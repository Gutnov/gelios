<div class="catalog-carousel">
	<div class="products-carousel__head">
		<div class="products-carousel__title">С большой скидкой</div>
	...
	<div class="products-carousel-wr">
		<?php
			...
			{
				$detailPicture2x = CFile::ResizeImageGet($product['DETAIL_PICTURE'], ['width' => 828, 'height' => 828]);
				$detailPicture1x = CFile::ResizeImageGet($product['DETAIL_PICTURE'], ['width' => 552, 'height' => 552]);
				?>
				<div class="product-carousel-slide-wr">
					<div class="product-item _product-rating <?=($product['PROPERTIES']['DISCOUNT']['VALUE'])?'product-item_sale':''?>" data-rating="4.4">
						<div class="product-item__actions">
							...
							<a
								...
								onclick="bigDisCatalog.toggleFavorite(this, event, <?=$product['ID']?>)"
							...
							<div class="product-item__control">
								...
								else
								{
									...
									<a
										...
										onclick="bigDisCatalog.addToBasket(this, event, <?=$product['ID']?>)"
