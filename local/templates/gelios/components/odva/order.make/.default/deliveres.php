		...
		<div class="order-register__form order-register__form--delivery">
			<form action="">
				<div class="order-register__form-item">
					<span>Город *</span>
					<input type="text" onchange="makeOrder.changeInput(this)" class="order-register__form-item--city" name="city" placeholder="Введите название города">
				</div>
				<div class="order-register__form-item">
					<span>Улица *</span>
					<input type="text" onchange="makeOrder.changeInput(this)" class="order-register__form-item--street" name="street" placeholder="Введите название улицы">
				</div>
				<div class="order-register__form-item">
					<span>Дом *</span>
					<input type="text" onchange="makeOrder.changeInput(this)" class="order-register__form-item--home" name="home" placeholder="Введите номер дома">
				</div>
				<div class="order-register__form-item">
					<span>Квартира *</span>
					<input type="email" onchange="makeOrder.changeInput(this)" class="order-register__form-item--floor" name="apartment" placeholder="Введите номер квартры">
				</div>
			</form>
		</div>
