...
if(!$resultUser)
{
	echo json_encode(['success'=>false,'msg'=>'Пользователя с такой почтой не существует!']);
	exit();
}
...
if($result)
{
	echo json_encode(['success' => true,'msg' => 'Ваш новый пароль отпавлен на почту \''.$_POST['email'].'\'']);
}
else
{
