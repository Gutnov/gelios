...
var jsFiles = [
	...
	'js/vendors/jquery.mask.js',
	'js/vendors/lazyload.min.js',
	'js/vendors/anime.min.js',
	'js/modules/productItem.js',
...
gulp.task('default', gulp.parallel('watch', 'browser-sync', 'sass', 'twig', 'svg-min', 'svg-sprite', 'scripts', () => { ('dev start');}));console.log